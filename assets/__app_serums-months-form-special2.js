...
let s__product_variant = 45951954419951; //default product variant
...
s__product_variants[1][2] = 45951933022447; //2 months
s__product_variants[1][3] = 45951935217903; //3 months

//Rejuvenating
s__product_variants[2] = []; 
s__product_variants[2][1] = 43216457203951; //1 month
s__product_variants[2][2] = 45951954419951; //2 months
s__product_variants[2][3] = 45951948947695; //3 months

//Hydra-Soothing
s__product_variants[3] = [];
s__product_variants[3][1] = 43216483942639; //1 month
s__product_variants[3][2] = 45951928860911; //2 months
s__product_variants[3][3] = 45951945474287; //3 months
